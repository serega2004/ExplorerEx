...
LRESULT CLogoffPane::_OnCreate(LPARAM lParam)
{
    ...
    if (_hwndTB)
    {
        ...
        SendMessage(_hwndTB, TB_ADDSTRING, (WPARAM) GetModuleHandle(NULL), (LPARAM) idText);
            ...
            case TBN_GETINFOTIP:
                {
                    ...
                    LoadString(GetModuleHandle(NULL), ptbgit->lParam, ptbgit->pszText, ptbgit->cchTextMax);
                    return TRUE;
                }
