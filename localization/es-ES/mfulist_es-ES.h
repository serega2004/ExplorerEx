...
#define MFU_SETDEFAULTS "%ALLUSERSPROFILE%\\Menú Inicio\\Configurar acceso y programas predeterminados.lnk"

//
//  32-bit Client for all user types
//
#define MFU_PRO32ALL_00 "%USERPROFILE%\\Menú Inicio\\Programas\\Internet Explorer.lnk"
#define MFU_PRO32ALL_01 "%ALLUSERSPROFILE%\\Start Menu\\Programs\\Accessories\\Media Center\\Media Center.lnk"
#define MFU_PRO32ALL_02 "%ALLUSERSPROFILE%\\Menú Inicio\\Programas\\Diario de Windows.lnk"
#define MFU_PRO32ALL_03 "%ALLUSERSPROFILE%\\Menú Inicio\\Configurar acceso y programas predeterminados.lnk"
#define MFU_PRO32ALL_04 "%ALLUSERSPROFILE%\\Menú Inicio\\Programas\\Get Going with Tablet PC.lnk"
#define MFU_PRO32ALL_05 "%ALLUSERSPROFILE%\\Menú Inicio\\Programas\\Conéctese con MSN.lnk"
...
#define MFU_PRO64ALL_01 "%ALLUSERSPROFILE%\\Menú Inicio\\Programas\\Diario de Windows.lnk"
#define MFU_PRO64ALL_02 "%ALLUSERSPROFILE%\\Menú Inicio\\Configurar acceso y programas predeterminados.lnk"
#define MFU_PRO64ALL_03 "%ALLUSERSPROFILE%\\Menú Inicio\\Programas\\Get Going with Tablet PC.lnk"
#define MFU_PRO64ALL_04 "%ALLUSERSPROFILE%\\Menú Inicio\\Programas\\Conéctese con MSN.lnk"
#define MFU_PRO64ALL_05 "%ALLUSERSPROFILE%\\Menú Inicio\\Programas\\MSN Explorer.lnk"
#define MFU_PRO64ALL_06 "%USERPROFILE%\\Menú Inicio\\Programas\\Reproductor de Windows Media.lnk"
#define MFU_PRO64ALL_07 "%ALLUSERSPROFILE%\\Menú Inicio\\Programas\\Accesorios\\Windows Messenger.lnk"
#define MFU_PRO64ALL_08 "%USERPROFILE%\\Menú Inicio\\Programas\\Accesorios\\Paseo por Windows XP.lnk"
#define MFU_PRO64ALL_09 "%ALLUSERSPROFILE%\\Menú Inicio\\Programas\\Accesorios\\Windows Movie Maker.lnk"
#define MFU_PRO64ALL_10 "%ALLUSERSPROFILE%\\Menú Inicio\\Programas\\Accesorios\\Herramientas del sistema\\Asistente para transferencia de archivos y configuraciones.lnk"
